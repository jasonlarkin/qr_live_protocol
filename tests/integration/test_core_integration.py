...
class TestQRLiveProtocolIntegration:
    ...
    def test_component_initialization_integration(self, mock_identity, mock_blockchain, mock_time, mock_qr):
    ...
    @patch('src.core.BlockchainVerifier')
    @patch('src.core.IdentityManager')
    def test_qr_generation_integration(self, mock_identity, mock_blockchain, mock_time, mock_qr):
    ...
    @patch('src.core.BlockchainVerifier')
    @patch('src.core.IdentityManager')
    def test_callback_system_integration(self, mock_identity, mock_blockchain, mock_time, mock_qr):
    ...
    @patch('src.core.BlockchainVerifier')
    @patch('src.core.IdentityManager')
    def test_statistics_integration(self, mock_identity, mock_blockchain, mock_time, mock_qr):
    ...
    @patch('src.core.BlockchainVerifier')
    @patch('src.core.IdentityManager')
    def test_verification_integration(self, mock_identity, mock_blockchain, mock_time, mock_qr):
